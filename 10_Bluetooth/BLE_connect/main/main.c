...
{
    os_mbuf_append(ctxt->om, "Hello from ESP32", strlen("Hello from ESP32"));
    return 0;
}
...
static const struct ble_gatt_svc_def gatt_svcs[] = {
    {.type = BLE_GATT_SVC_TYPE_PRIMARY,
     .uuid = BLE_UUID16_DECLARE(0x1801),                 // Define UUID for device type
...
ret = nvs_flash_init();  // 1 - Initialize NVS flash using
if (ret != ESP_OK) {
